...
//MAPPING - for key-value lookups
    ...
    function createPerson(string memory name, uint age, uint height, bool senior, uint salary) public payable costs(100 wei){

    // REQUIRE - conditions to be met to execute
        require(age <= 75, "Age needs to be below 150");
